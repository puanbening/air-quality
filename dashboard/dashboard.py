...
def load_data():
    wanliu_df = pd.read_csv("https://raw.githubusercontent.com/puanbening/air-quality/main/dashboard/Air-quality-dataset/PRSA_Data_20130301-20170228/PRSA_Data_Wanliu_20130301-20170228.csv")
    return wanliu_df
